...
var RevealTableOfContents = window.RevealTableOfContents || (function () {
    ...
    var tocColor = options.fontColor;
    var listStyle = options.listStyle; 
    var embrace = options.embrace;
    var embraceCharacter = options.embraceCharacter;
    ...
    function generateList() {
        ...
        for (counter; counter < slides.length; counter++) {
            ...
            if (title !== undefined) {
                ...
                if (embrace === true) {
                    li.innerText = embraceCharacter + " " + title + " " + embraceCharacter;                    
                } else {
                    li.innerText = title;
                }
